...
typedef DualTransitionAnimationBuilderCallback = List<DualTransitionAnimation> Function(
  Animation<double> animation,
  Animation<double>? secondaryAnimation,
);

typedef DualTransitionAnimationWidgetBuilder = Widget Function(
  BuildContext context,
  List<DualTransitionAnimation> animations,
  Widget child,
);
