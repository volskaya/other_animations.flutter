...
class PageTransitionSwitcher extends StatefulWidget {
  ...
  @override
  PageTransitionSwitcherState createState() => PageTransitionSwitcherState();
}

class PageTransitionSwitcherState extends State<PageTransitionSwitcher> with TickerProviderStateMixin {
